...
heart_disease_model=pickle.load(open(r"C:\Users\rsais\create_new\traing_models\heart_model.sav",'rb'))
parkinson_model=pickle.load(open(r"C:\Users\rsais\create_new\traing_models\parkinsons_model.sav",'rb'))
